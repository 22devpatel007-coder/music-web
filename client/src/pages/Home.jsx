...
const Home = () => {
  const { data, isLoading: loading, isFetchingNextPage: loadingMore, error, hasNextPage: hasMore, fetchNextPage: fetchMore, refetch } = useSongs();
  ...
  const { recentlyPlayed, playSong, currentSong, isPlaying } = usePlayerStore();
